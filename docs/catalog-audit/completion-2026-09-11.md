# Catalog completion, 11 September 2026

The established workout planner, eligibility, ranking, state, history, recovery
and Oura behavior were restored. The scope-confirmation UI and broader-grouping
redesign were withdrawn. Catalog and final-media corrections remain intact.

## Teacup Arm Circles, 1027

The [instructor's demonstration](https://www.youtube.com/watch?v=HYv5FLO4beY)
provides a complete simultaneous bilateral cycle at 261–270 seconds. Its nine
seconds are preserved at normal speed in
`tools/ReviewedSourceMedia/teacups-kseny-261-9.mp4`, SHA-256
`a06b72a0bf9a7579dd22187e5bf73e830b2440100fb08aba7f63e7f123744d23`.

Both feet remain planted and both shoes and the complete arm path stay visible.
This is quiet, equipment-free, ordinary-shoe arm mobility, with no impact,
foot pivot, travel or traction-loaded lateral shift. It is Hard Floor and Shy
compatible. It is arm-dominant and **Insect incompatible**.

The deliberate shoulder elevation/rotation, elbow flexion/extension and forearm
rotation support RotatorCuff as primary and the five reviewed shoulder, elbow
and forearm secondary claims. Demand remains 0. No torso or lower-body training
...
console errors. No timer acceleration was used. Evidence is in
[`evidence/2026-09-11/1027`](evidence/2026-09-11/1027); the explicit review is
bound to metadata and video hashes in the review ledger.

The catalog has 540 retained entries, all with current passing review hashes.
This admission reduces complete-lineup failures from 70 to 55 under the
established planner. These are overlapping profile/duration failures, not 55
unique missing exercises. The remaining failures still prevent release.

Catalog revision 74 and database version 90 admit the new identity without
invalidating existing scores or Keeps. Focused checks pass: 67 Android tests,
five paired web completion/migration tests, 40 web/native contract tests and
