...
The existing Breath of Joy family 480/517 already contains the exact three
inhales, arm sweeps and audible fold-exhale. It was reinspected and its Insect
verdict corrected; see the completion record. No duplicate was added.

- Dana-Farber `llZeyGKUAjY`: inspected; seated/waist-up framing cannot replace the standing full-body demonstration.
- Krista `QXN5-ZzcABE`: inspected complete source sheet; late standing cycles are a possible alternative, but the existing family already has clearer reviewed media.
- Jon Haas `WzOo_ezneBQ`: advanced repeated breath-hold squats differ from the instructor's beginner three-squat-and-recover protocol.
- Jon Haas `RpcM3Om8Bdo`: inspected; kneeling/floor contact.
- Dexter `am9mJUHETIU`: inspected; advanced apnea, edited inset and recovery-chair context do not establish a simple beginner 45-second exercise.
- Mim Beim `wvrOcSxwW7s`: inspected; courtyard walking exceeds the permitted area.

The [beginner protocol](https://warriorfitness.org/tag/yoga/) and short-hold
protocols do not authorize arbitrary continuous 45-second breath holding.
No ordinary movement receives a breathing-muscle claim merely because someone
could hold their breath while doing it.

## Heel digs and rocking

[BHF](https://www.bhf.org.uk/informationsupport/heart-matters-magazine/activity/balance-exercises)
documents alternating heel digs as an established movement. Any anterior-leg
claim requires deliberate visible ankle dorsiflexion, not ordinary gait or
unverified shaking. The owner's Heel Walks (194) Hard Floor exclusion stands.
...
- Sculpt Your Life `WNCx1VaYr74`, Justin Stone `OcMuJpw1oYQ`, Travis Elliot `KylfzFhGxRs`: inspected parallel rocking leads remain unapproved; small calf displacement and arm swinging alone do not establish the required continuous whole-body action.

## Bilateral thigh squeeze

The owner suggested pressing the inner thighs together while standing. Exact
